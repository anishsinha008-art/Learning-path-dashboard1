...
/* --- Fade + slide animation container --- */
.section-container {
...
st.markdown(f'<div class="{menu_class}"><h3>📚 Dashboard Menu</h3>', unsafe_allow_html=True)
...
if st.session_state.active_section == "Home":
    ...
    Use the ☰ menu on the top-left to explore sections.
    """)
